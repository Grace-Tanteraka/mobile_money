                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card op-card p-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                <h5 class="fw-bold mb-0">Transfert vers un autre client</h5>
                                <small class="text-muted">Envoyez de l'argent à un numéro Mobile Money</small>
                            </div>
                        </div>

                        <form action="<?= site_url('client/transferer') ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="montant" class="form-control" min="100" step="0.01" placeholder="ex: 10000" required>
                                </div>
                                <small class="text-muted">Montant minimum : 100 Ar. Des frais de transfert s'appliquent.</small>
                            </div>
                            <button type="submit" class="btn btn-primary w-100 fw-semibold text-white">
                                <i class="fa-solid fa-paper-plane me-2"></i>Valider le transfert
                            </button>
                        </form>
                    </div>
                </div>
