    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="d-flex justify-content-between align-items-center pb-3 mb-4 border-bottom">
                <h1 class="h3 fw-bold">Effectuer un dépôt</h1>
            </div>
                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card op-card p-4">
                        <div class="d-flex align-items-center mb-4">
                            <div class="op-icon bg-success-subtle text-success me-3">
                                <i class="fa-solid fa-plus-circle fa-lg"></i>
                            </div>
                            <div>
                                <h5 class="fw-bold mb-0">Dépôt d'argent</h5>
                                <small class="text-muted">Créditez votre solde Mobile Money</small>
                            </div>
                        </div>

                        <form action="<?= site_url('client/faire_depot') ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Montant (Ar)</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light">Ar</span>
                                    <input type="number" name="montant" class="form-control" min="100" step="0.01" placeholder="ex: 50000" required>
                                </div>
                                <small class="text-muted">Montant minimum : 100 Ar</small>
                            </div>
                            <button type="submit" class="btn btn-success w-100 fw-semibold text-white">
                                <i class="fa-solid fa-plus-circle me-2"></i>Valider le dépôt
                            </button>
                        </form>
                    </div>
                </div>
